...
{
	//KnuclesCrosshair - see KnucklesCrosshair.png
	KnucklesCrosshair
	{
		...
		"font"			"CrossMed"
		"fgcolor"		"255 255 255 255"			//Changes colour - format is rgb		
		"labelText"		"k"							//change this to the letter of the crosshair you want
	}
	
	
	//default crosshair	- to remove change visible and enabled to 0
	Circle
	{
		"fieldName"		"Circle"
		"controlName"	"CExLabel"
